  ...
  const PROJECTS = [
    {
      id: 'p1',
      name: 'Versa-Train',
      description: 'This Application is a full MERN Stack Application using Apollo GraphQL. Its funtionality is for employers to create and host their training material so that their employees can stay up to date with required job training. 
