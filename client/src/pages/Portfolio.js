...
const Portfolio = () => {
  const PROJECTS = [
    ...
    },
    {
      ...
      name: 'Shop-Shop',
      description:
        'This is Shop-Shop, a full MERN Stack SPA e-commerce application using Apollo GraphQl and Redux for state. This application also has offline functionality through IndexedDb',
      image: Img5,
    ...
    },
    {
      ...
      name: 'Deep Thoughts',
      description:
        'This is Deep Thoughts, a full MERN Stack SPA social media application using Apollo GraphQl',
      image: Img,
    ...
    },
    {
      ...
      name: 'My Tech Now',
      description:
        'Fullstack application using Mysql, Express, Handlebars, and a Restful Api',
      image: Img2,
    ...
    },
    {
      ...
      name: 'Pizza Hunt',
      description:
        'This is Pizza Hunt a Fullstack NoSql application using MongoDb, and Express with a Restful Api',
      image: Img4,
